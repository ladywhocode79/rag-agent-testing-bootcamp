...
question_1 = "How should I clean the Sony headphones?"
...
question_2   = "How should I clean the Sony headphones?"
fake_context = [
    "The Sony WH-1000XM4 headphones are fully waterproof and can be rinsed under running water.",
    "Use alcohol or acetone wipes for deep cleaning the ear cups."
]
